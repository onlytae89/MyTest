...
//            2、处理请求
            ...
            HttpResponse response = new HttpResponse(socket);                   //7.2
...
//                String line = "HTTP/1.1 404 NOT FOUND";  //发送错误页面的状态行                     //6.1
...
//                }
            ...
            System.out.println("ClientHandler：处理请求完毕");                        //3.7
//            3、响应客户端
            System.out.println("ClientHandler:开始发送响应");
            response.flush();
            System.out.println("ClientHandler:发送响应完毕");
            System.out.println("ClientHandler:处完毕");
        }catch(Exception e){
            e.printStackTrace();
        }finally {
